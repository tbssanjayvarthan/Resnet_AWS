...
title = "ResNet Model"
description = " Deep residual networks pre-trained on ImageNet dataset. upload your image (for test)"
examples = [
            ['dog.jpg']
]

gr.Interface(inference, inputs, outputs, title=title, description=description, analytics_enabled=False).launch()
